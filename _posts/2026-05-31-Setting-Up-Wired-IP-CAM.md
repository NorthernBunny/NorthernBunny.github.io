...
This project turned out to be more work and cost than I expected at the beginning. I wasn't expecting to pay more for things like fancy outdoor Ethernet, a high-performance SD card, specialized clips, sealant, and potentially a long drill bit. At this point, the camera is officially live, the 4K local playback is working well, and I’ve already kicked off my very first time-lapse! The question is, after spending about $400, and executing substantially more effort than deploying a wireless indoor, or even a wireless outdoor camera, is it worth it?
